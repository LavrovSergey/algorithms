...
public:
	...
	void add_good(const std::string& name)
	{
...
int main()
{
	...
	while (true)
	{
		...
		else if (operation == "insertgoods")
		{
			...
			Section* finded = splay_tree.search(temp);
			int count;
			cin >> count;
			string goods_name;
			if (finded)
